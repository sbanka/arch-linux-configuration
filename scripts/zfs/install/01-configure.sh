...
function _main() {
        ...
        if [[ -z ${keymap+x} ]]; then
                ...
                ask "0) en   1) de-latin1 (default)   2) input your own"
        ...
        if [[ -z ${locale+x} ]]; then
                ...
                ask "0) en_US   1) de_DE (default)   2) input your own"
        ...
        if [[ -z ${timezone+x} ]]; then
                ...
                ask "0) Europe/Paris   1) America/Chicago (default)   2) input your own"
        ...
        if [[ -z ${zfskernelmode+x} ]]; then
                ...
                if [[ ${kernel} == "linux" ]]; then
                        ...
                        *)
                        ...
                        case ${REPLY:-0} in
                        1)
                                zfskernelmode="archzfs-linux-lts"
                                ;;
                        *)
                                zfskernelmode="archzfs-dkms"
                                ;;
